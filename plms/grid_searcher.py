...
class GridSearcher:
    ...
    def __init__(self, checkpoint_dir: str, dataset_path: str = "shnl/qg-example", dataset_name: str = "default",
                 input_types: List or str = 'paragraph_answer', output_types: List or str = 'question',
                 prefix_types: List or str = 'qg', model: str = 'VietAI/vit5-base', fp16: bool = False,
                 ...
                 label_smoothing: List or float = None, random_seed: List or int = 42, language: str = 'vi',
